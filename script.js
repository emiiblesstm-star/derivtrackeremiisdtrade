document.addEventListener('DOMContentLoaded', () => {
    ...
    // Configuration
    const TARGET_APP_ID = 92303; // App ID to filter markup statistics
    ...
    const apiToken = '0TZ6Ky3p7EuiZfQ'; // Replace with your actual token
    const appId = 92303;
    const accountNumber = 'CR9423144';
